...
class Base():
    ...
    def to_json(self, for_serialization: bool = False) -> dict:
        """Function for  Convert the object a JSON dictionary.
        """
        result = {}
    ...
    def load_from_file(cls):
        """Function for  Load all objects from file.
        """
        s_class = cls.__name__
        filePath = ".db_{}.json".format(s_class)
        DATA[s_class] = {}
    ...
    def save_to_file(cls):
        """Function for  Save all objects to file.
        """
        s_class = cls.__name__
        filePath = ".db_{}.json".format(s_class)
        objs_json = {}
    ...
    def save(self):
        """Function for Save current object.
        """
    ...
    @classmethod
    def count(cls) -> int:
        """Function for Count all objects.
        """
        s_class = cls.__name__
    ...
    def all(cls) -> Iterable[TypeVar('Base')]:
        """Function for Return all objects.
        """
        return cls.search()

    @classmethod
    def get(cls, id: str) -> TypeVar('Base'):
        """Function for Return one object by ID.
        """
        s_class = cls.__name__
    ...
    def search(cls, attributes: dict = {}) -> List[TypeVar('Base')]:
        """Function for Search all objects 
        """
        s_class = cls.__name__
        def _search(obj):
            if len(attributes) == 0:
